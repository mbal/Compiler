...
-- splits a 16 bit number into two 8 bits groups.
-- the first number is composed by the lower order bits
-- the second number in the result are the most significant digits
